    ...
    <div class="md-layout md-gutter">
      ...
      <div class="md-layout-item md-size-30 md-medium-size-30 md-small-size-100">
        <div class="md-layout md-gutter">
          ...
          <div class="md-layout-item md-size-100">
            ...
            <md-card v-if="channel.tiers._2.active" class="tier md-elevation-2">
              <md-card-header>
                <md-card-header-text style="display: flex; justify-content: space-between; align-items: center;">
                  <div class="md-title">
            ...
            <md-card v-if="channel.tiers._3.active" class="tier md-elevation-2">
              <md-card-header>
                <md-card-header-text style="display: flex; justify-content: space-between; align-items: center;">
                  <div class="md-title">
      ...
      <div class="md-layout-item md-size-70 md-medium-size-70 md-small-size-100 content">
        ...
        <div class="md-layout md-gutter">
          ...
          <div class="md-layout-item md-size-66" style="margin-top: 32px;">
            <div class="header">Releases</div>
            <md-divider style="margin-top: 16px;"/>
            <template v-if="channel.releases.length">
              <div v-for="release in channel.releases" :key="release.time_created" :class="{ noclick: ($store.state.role === 'channel') || (!!subscription && subscription.tier < release.tier) || (!subscription && !channel.tiers[`_${release.tier}`].active) }" class="card">
                <nuxt-link
                  :to="`/channels/${channel.slug}/${release.slug}`"
                  :event="''"
                  @click.native.prevent="(subscription || {}).tier >= release.tier ? go(`/channels/${channel.slug}/${release.slug}`) : confirmSubscription(release.tier)">
                    ...
                    <md-card-media-cover md-solid>
                      ...
                      <md-card-area>
                        <md-card-header class="release-text">
                          ...
                          <md-icon v-if="(subscription || {}).tier >= release.tier">lock_open</md-icon>
          ...
          <div class="md-layout-item md-size-33" style="margin-top: 32px;">
            <div class="header">Syndicates</div>
            <md-divider style="margin-top: 16px;"/>
            <template v-if="channel.syndicates.length">
              <div v-for="syndicate in channel.syndicates" :key="syndicate.syndicate_id" class="card">
