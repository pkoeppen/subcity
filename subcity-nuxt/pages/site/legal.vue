  ...
  <div>
    <md-toolbar class="toolbar" md-elevation="0">
      <div class="container" style="display: flex; justify-content: space-between; align-items: center;">
        <div>
          <nuxt-link to="/">&raquo; site</nuxt-link>
          <nuxt-link to="/site/guide" style="margin-left: 8px;">&raquo; legal</nuxt-link>
        </div>
        <md-badge class="badge md-square md-primary" md-content="Updated: 16 Jan 2019" />
      </div>
    </md-toolbar>
    <section class="container" style="margin-top: 32px;">
      <div class="md-layout" style="justify-content: center;">
        <div class="md-layout-item md-size-80 md-small-size-100">
          <md-card>
            <md-card-header style="display: flex; justify-content: space-between; align-items: center; padding: 32px 32px 0;">
              <div class="md-display-2 bold-italic" style="text-transform: uppercase;">Terms of Service</div>
              <md-icon style="margin: 0;">vpn_lock</md-icon>
            </md-card-header>
            <md-card-content style="padding: 16px 32px 32px;">
              <md-divider style="margin-bottom: 32px;"/>
              <div class="md-title">1. Terms</div>
              <p>By accessing the website at <nuxt-link to="/">sub.city</nuxt-link>, you are agreeing to be bound by these terms of service, all applicable laws and regulations, and agree that you are responsible for compliance with any applicable local laws. If you do not agree with any of these terms, you are prohibited from using or accessing this site. The materials contained in this website are protected by applicable copyright and trademark law.</p>
              <div class="md-title">2. Use License</div>
              <ol type="a">
                 <li>Permission is granted to temporarily download one copy of the materials (information or software) on sub.city's website for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:
                 <ol type="i">
                     <li>modify or copy the materials;</li>
                     <li>use the materials for any commercial purpose, or for any public display (commercial or non-commercial);</li>
                     <li>attempt to decompile or reverse engineer any software contained on sub.city's website;</li>
                     <li>remove any copyright or other proprietary notations from the materials; or</li>
                     <li>transfer the materials to another person or "mirror" the materials on any other server.</li>
                 </ol>
                  </li>
                 <li>This license shall automatically terminate if you violate any of these restrictions and may be terminated by sub.city at any time. Upon terminating your viewing of these materials or upon the termination of this license, you must destroy any downloaded materials in your possession whether in electronic or printed format.</li>
              </ol>
              <div class="md-title">3. Disclaimer</div>
              <ol type="a">
                 <li>The materials on sub.city's website are provided on an 'as is' basis. sub.city makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties including, without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights.</li>
                 <li>Further, sub.city does not warrant or make any representations concerning the accuracy, likely results, or reliability of the use of the materials on its website or otherwise relating to such materials or on any sites linked to this site.</li>
              </ol>
              <div class="md-title">4. Limitations</div>
              <p>In no event shall sub.city or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on sub.city's website, even if sub.city or a sub.city authorized representative has been notified orally or in writing of the possibility of such damage. Because some jurisdictions do not allow limitations on implied warranties, or limitations of liability for consequential or incidental damages, these limitations may not apply to you.</p>
              <div class="md-title">5. Accuracy of materials</div>
              <p>The materials appearing on sub.city's website could include technical, typographical, or photographic errors. sub.city does not warrant that any of the materials on its website are accurate, complete or current. sub.city may make changes to the materials contained on its website at any time without notice. However sub.city does not make any commitment to update the materials.</p>
              <div class="md-title">6. Links</div>
              <p>sub.city has not reviewed all of the sites linked to its website and is not responsible for the contents of any such linked site. The inclusion of any link does not imply endorsement by sub.city of the site. Use of any such linked website is at the user's own risk.</p>
              <div class="md-title">7. Modifications</div>
              <p>sub.city may revise these terms of service for its website at any time without notice. By using this website you are agreeing to be bound by the then current version of these terms of service.</p>
              <div class="md-title">8. Governing Law</div>
        ...
        <div class="md-layout-item md-size-80 md-small-size-100">
          <md-card>
            <md-card-header style="display: flex; justify-content: space-between; align-items: center; padding: 32px 32px 0;">
              <div class="md-display-2 bold-italic" style="text-transform: uppercase;">Privacy Policy</div>
              <md-icon style="margin: 0;">vpn_lock</md-icon>
            </md-card-header>
            <md-card-content style="padding: 16px 32px 32px;">
              <md-divider style="margin-bottom: 32px;"/>
              <p>Your privacy is important to us. It is our policy to respect your privacy regarding any information we may collect from you across our website, <nuxt-link to="/">sub.city</nuxt-link>, and other sites we own and operate.</p>
              <div class="md-title" style="margin-bottom: 16px;">1. Information we collect</div>
              ...
              <div class="md-title">2. Legal bases for processing</div>
              ...
              <div class="md-title">3. Collection and use of information</div>
              ...
              <div class="md-title">4. Disclosure of personal information to third parties</div>
              ...
              <div class="md-title">5. International transfers of personal information</div>
              ...
              <div class="md-title">6. Your rights and controlling your personal information</div>
              ...
              <div class="md-title">7. Cookies</div>
              ...
              <div class="md-title">8. Business transfers</div>
              ...
              <div class="md-title">9. Limits of our policy</div>
              <p>Our website may link to external sites that are not operated by us. Please be aware that we have no control over the content and policies of those sites, and cannot accept responsibility or liability for their respective privacy practices.</p>
              <div class="md-title">10. Changes to this policy</div>
              ...
              <p>This policy is effective as of 16 January 2019.</p>
            </md-card-content>
          </md-card>
        </div>
        <div class="md-layout-item md-size-80 md-small-size-100">
          <md-card>
            <md-card-header style="display: flex; justify-content: space-between; align-items: center; padding: 32px 32px 0;">
              <div class="md-display-2 bold-italic" style="text-transform: uppercase;">Cookie Policy</div>
              <md-icon style="margin: 0;">vpn_lock</md-icon>
            </md-card-header>
            <md-card-content style="padding: 16px 32px 32px;">
              <md-divider style="margin-bottom: 32px;"/>
              <p>We use cookies to help improve your experience of <nuxt-link to="/">sub.city</nuxt-link>. This cookie policy is part of sub.city's privacy policy, and covers the use of cookies between your device and our site.</p>
              <p>If you don’t wish to accept cookies from us, you should instruct your browser to refuse cookies from <nuxt-link to="/">sub.city</nuxt-link>, with the understanding that we may be unable to provide you with some of your desired content and services.</p>
      ...
      <div style="display: flex; justify-content: center; align-items: center; margin: 40px 0; color: #666;">
        <span class="bold-italic" style="margin-right: 8px;">Enjoy the site!</span>
        <md-icon style="margin: 0;">insert_emoticon</md-icon>
      </div>
    </section>
  </div>
</template>
